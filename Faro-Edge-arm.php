...
if (isset($_POST['add_to_cart'])) {
  ...
  if (mysqli_num_rows($select_cart) > 0) {
    $display_message = "Product already Added in Cart";
...
if (isset($_POST['buy_now1'])) {
 ...
 echo "<script type='text/javascript'>window.location.href='direct-checkout-Faro-Edge-arm.php';</script>";
            exit();
}
?>
...
<head>
  ...
  <meta property="twitter:title" content="Faro Edge arm"/>
  <meta name="twitter:description"
    content="Precise3DM Provides complete digital manufacturing solution that includes 3D scanning services, 3D reverse engineering, 3D Printing services & 3d Inspection for all industries" />
  <meta property="og:type" content="3D Scanning" />
  <meta property="og:title" content="Faro Edge arm" />
  <meta property="og:url" content="https://www.precise3dm.com/Faro-Edge-arm.php" />
  <meta property="og:image" content="https://www.precise3dm.com/assets/images/about-logo.png" />
  <meta property="og:description"
    content="Precise3DM Provides complete digital manufacturing solution that includes 3D scanning services, 3D reverse engineering, 3D Printing services & 3d Inspection for all industries" />
  <meta property="twitter:url" content="https://www.precise3dm.com/Faro-Edge-arm.php" />
  <link rel="canonical" href="https://www.precise3dm.com/Faro-Edge-arm.php"/>
  <!--bootstrap css-->
  ...
  <link rel="canonical" href="https://www.precise3dm.com/" />
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "position": 2, 
        "name": "Faro Edge arm",
        "item": "https://www.precise3dm.com/Faro-Edge-arm.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/Faro-Edge-arm.php"
      },
      "headline": "Faro Edge arm",
      ...
      <form action="" method="post" action="">
        <div class="container">
          <div class="row">
            ...
            <?php
            $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` LIMIT 1 OFFSET 2");
              ...
              while ($fetch_cart_product = mysqli_fetch_assoc($select_cart_product)) {
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="details">
                    ...
                    <p>Portable measurement arm type blue laser 3D Scanner</p>
                    <h5>Accuracy: <span class="hd-scan"> 0.03mm / Probing : 0.001</span></h5>
                    <small class="text-muted">₹ 15 lakhs<span class="mrp"> M.R.P. : ₹18 lakhs</span></small><br>
                    ...
                    <ul>
                      <li>
                        Arm laser 3D Scanning service, integrating both 3D Scanning and probing, helps capture the complicated
                        freeform shape along with 2D features using probing, such as holes positions, extract planes, slots,
                        and other geometries for various applications.
                      </li>
                      <li>
                        Faro edge arm has provision for mounting different length probes to measure and extract features that
                        difficult to access.
                      </li>
                    </ul>
                    <h5>Quantity</h5>
          ...
          <div class="product-sec owl-carousel">
            ...
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <h6>Accuracy: <span style="color:grey; font-weight:200; font-size:14px;"> 0.03mm / Probing :
                    0.001</span>
                </h6>
                <div class="card-footer">
