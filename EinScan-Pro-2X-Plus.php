...
if (isset($_POST['buy_now1'])) {
  ...
  header("Location: direct-checkout-EinScan-Pro-2XPlus.php");
  exit();
}
?>
...
if (isset($_POST['buy_now'])) {
  ...
  if (mysqli_query($con, $update_quantity_query)) {
    echo "<script type='text/javascript'>window.location.href='direct-checkout-EinScan-Pro-2XPlus.php';</script>";
...
<head>
  ...
  <title>EinScan Pro 2X Plus</title>
  ...
  <meta property="twitter:title" content="EinScan Pro 2X Plus"/>
  <meta name="twitter:description"
    content="Precise3DM Provides complete digital manufacturing solution that includes 3D scanning services, 3D reverse engineering, 3D Printing services & 3d Inspection for all industries" />
  <meta property="og:type" content="3D Scanning" />
  <meta property="og:title" content="EinScan Pro 2X Plus" />
  <meta property="og:url" content="https://www.precise3dm.com/EinScan-Pro-2X-Plus.php" />
  <meta property="og:image" content="https://www.precise3dm.com/assets/images/about-logo.png" />
  <meta property="og:description"
    content="Precise3DM Provides complete digital manufacturing solution that includes 3D scanning services, 3D reverse engineering, 3D Printing services & 3d Inspection for all industries" />
  <meta property="twitter:url" content="https://www.precise3dm.com/EinScan-Pro-2X-Plus.php" />
  <link rel="canonical" href="https://www.precise3dm.com/EinScan-Pro-2X-Plus.php"/>
  <!--bootstrap css-->
  ...
  <link rel="canonical" href="https://www.precise3dm.com/" />
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "@type": "ListItem", 
        "position": 2, 
        "name": "EinScan Pro 2X Plus",
        "item": "https://www.precise3dm.com/EinScan-Pro-2X-Plus.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/EinScan-Pro-2X-Plus.php"
      },
      "headline": "EinScan Pro 2X Plus",
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <section class="scanner-section">
    ...
    <?php
    $select_product = mysqli_query($con, "SELECT * FROM `products` LIMIT 1 OFFSET 3");
      ...
      <form action="" method="post" action="">
        <div class="container">
          <div class="row">
            ...
            <?php
            $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` LIMIT 1 OFFSET 3");
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="details">
                    <div class="add-to-cart">
                      <h1>EinScan Pro 2X Plus</h1>
                    </div>

                    <p>Structured White LED Light 3D Scanner</p>
                    <h5>Accuracy: <span class="hd-scan"> 0.05 mm (0.002 in)</span></h5>
                    <small class="text-muted">₹ 4.6 lakhs<span class="mrp"> M.R.P. : ₹4.1 lakhs</span></small><br>
                    ...
                    <ul>
                      <li>
                        The scanner provides high-accuracy scanning with resolutions down to a fraction of a millimeter,
                        enabling precise and detailed capture of object surfaces.
                      </li>
                      <li>
                        It typically supports multiple scanning modes, such as handheld rapid scanning, fixed scanning, and
                        automatic turntable scanning, offering flexibility for different applications and object sizes.
                      </li>
                    </ul>
                    <h5>Quantity</h5>
  ...
  <section class="product-section">
    <h2>Recently Viewed <span>3D Scanners</span> </h2>
    <div class="container">
  ...
  <div class="container faq-sec">
    <h2>Our most <span>frequently</span> asked questions</h2>
    <div class="row">
