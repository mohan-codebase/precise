...
<head>
  ...
  <title>Payment Form - Einstar 2</title>

  <meta name="description" content="Checkout - Einstar 2 | Precise3DM">
...
<body style="background-color:#FFF9F3;">
  ...
  $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` WHERE id = 15");
  $product_title = '';
  $total_quantity = 0;
  $subtotal = 0.0;
