...
$product_offset = isset($_GET['product_offset']) ? (int)$_GET['product_offset'] :10;
$product = null;
...
$name  = $product ? $product['name']  : 'Einscan Rigil | The Tri-Mode Laser 3D scanner';
$price = $product ? (float)$product['price'] : 125000; // INR (DB base price)
$mrp   = ($product && isset($product['mrp'])) ? (float)$product['mrp'] : 650000;
$image = $product ? $product['image'] : 'assets/images/einscan-rigil/pro1.png';
...
if (isset($_POST['buy_now'])) {
 ...
 header("Location: direct-checkout-einscan-rigil.php?qty=" . urlencode($qty));
exit();
...
<head>
  ...
  <link rel="canonical" href="https://www.precise3dm.com/einscan-rigil-product.php"/>
  <!-- SweetAlert2 -->
      ...
      <div class="row row-cols-lg-2 row-cols-1 ">
        <div class="col mb-4">
          <div class="row">
            ...
            <div class="col-3 col-lg-2 px-lg-0">
              <div class="sub-imgs">
                <img src="assets/images/einscan-rigil/pro1.png" alt="" onclick="changeMainImage(this)">
                <img src="assets/images/einscan-rigil/pro2.png" alt="" onclick="changeMainImage(this)">
                <img src="assets/images/einscan-rigil/pro3.png" alt="" onclick="changeMainImage(this)">
                <img src="assets/images/einscan-rigil/pro4.png" alt="" onclick="changeMainImage(this)">
              </div>
            </div>
            <!-- Main image -->
            <div class="col-9 col-lg-10">
              <div class="main-img">
                <img id="mainProductImage" src="assets/images/einscan-rigil/pro1.png" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col">
          <div class="product-details">
            <h1>EinScan Rigil | The Tri-Mode Laser 3D scanner</h1>
            <div class="price-div">
              <h3>
            ...
            <ul class="desc">
              <li>Tri-mode handheld 3D scanner for small to large objects</li>
              <li>High accuracy up to 0.05 mm for detailed scans</li>
              <li>Standalone, wireless & wired scanning support</li>
              <li>Laser + infrared technology for versatile surfaces</li>
              <li>Fast, marker-free scanning even in bright environments</li>
            </ul>
