		...
		<div class="hero-text">
			...
			<div class="col-md-5">
                  <div class="logo-image">
                     <img align="center"src="assets/images/image2/image-7.png" class="img-fluid">
                  </div>
				  <br>
				  <h1 class="text-left" style="font-color:white;
           text-align: center !important;">FIGURE 4 EGGSHELL-AMB 10</h1>
               </div>
			   <br>
			   <div class="col-md-7">
                  <h4 class="text-left" style="font-color:white;">OVER VIEW</h4>
                  <P class="text-left">A process-optimized material for the production of sacrificial tooling for
				casting silicone and other materials.</P>
					 <div class="">
   ...
   <a href="#" class="btn pre-btn my-2 text-uppercase">GET A QUOTE</a>
	...
	<div class="column">
		 <h5 class="text-left pb-3">APPLICATIONS</h5>
			<P class="text-left" style="font-size:15px;">. For casting silicone parts in any durometer</P>
			<p class="text-left" style="font-size:15px;">. Customized end-use and low volume
			production parts of silicone material</p>
			<p class="text-left" style="font-size:15px;">.High-quality prototypes quickly produced</p>
	</div>
	<div class="column">
		<h5 class="text-left pb-3">BENEFITS</h5>
                  <P class="text-left" style="font-size:15px;">. Fine feature detail and digital textures applied
				to the sacrificial tooling for textured silicone
				parts</P>
				<P class="text-left" style="font-size:15px;">. Digital tooling for complex geometries</P>
                  <p class="text-left" style="font-size:15px;">.The end product can be cast with many silicones</p>
                  <p class="text-left" style="font-size:15px;">. Material translucency allows for visualization
					during injection</p>
	</div>
  <div class="column">
		<h5 class="text-left pb-3">FEATURES</h5>
                  <P class="text-left" style="font-size:15px;">. High HDT, high tensile modulus, and low elongation at break</P>
				  <P class="text-left" style="font-size:15px;">. Translucent, amber color</P>
                  <p class="text-left" style="font-size:15px;">. Withstands silicone injection at high temperature
					and pressure, but intentionally brittle to break
					away easily</p>
	</div>
</section>	
	</div>
...
<br>
	...
	<div class="column">
		 <h4 class="text-left pb-3">TECHNICAL SPECIFICATIONS</h4>
				  ...
				  <P class="text-left" style="font-size:15px;">. Elongation at break: 5%</P>
                  <p class="text-left" style="font-size:15px;">. Tensile modulus: 2765 MPa</p>
				  <p class="text-white" style="font-size:15px;">. Impact strength (notched Izod): 15 J/m</p>
			      <p class="text-white" style="font-size:15px;">. Heat Deflection Temperature @ 0.455 MPa: 89°C</p>
	</div>
</section>	
	</div>
      <!-- section end-->
