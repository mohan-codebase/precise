...
if (isset($_POST['buy_now1'])) {
  ...
  header("Location: direct-checkout-EinScan-Pro-HD.php");
  exit();
}
?>
...
if (isset($_POST['buy_now'])) {
  ...
  if (mysqli_query($con, $update_quantity_query)) {
    echo "<script type='text/javascript'>window.location.href='direct-checkout-EinScan-Pro-HD.php';</script>";
...
<head>
  ...
  <meta property="twitter:title" content="EinScan Pro HD" />
  <meta name="twitter:description"
    content="Precise3DM Provides complete digital manufacturing solution that includes 3D scanning services, 3D reverse engineering, 3D Printing services & 3d Inspection for all industries" />
  <meta property="og:type" content="3D Scanning" />
  <meta property="og:title" content="EinScan Pro HD" />
  <meta property="og:url" content="https://www.precise3dm.com/EinScan-Pro-HD.php" />
  <meta property="twitter:url" content="https://www.precise3dm.com/EinScan-Pro-HD.php" />
  <link rel="canonical" href="https://www.precise3dm.com/EinScan-Pro-HD.php"/>
  ...
  <link rel="canonical" href="https://www.precise3dm.com/" />
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "position": 2, 
        "name": "EinScan Pro HD",
        "item": "https://www.precise3dm.com/EinScan-Pro-HD.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/EinScan-Pro-HD.php"
      },
      "headline": "EinScan Pro HD",
...
<section class="filtersec pt-5 pb-5 mt-lg-5">
  ...
  <section class="scanner-section">
    ...
    <?php
    $select_product = mysqli_query($con, "SELECT * FROM `products` LIMIT 1 OFFSET 4");
      ...
      <form action="" method="post" action="">
        <div class="container">
          <div class="row">
            ...
            <?php
            $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` LIMIT 1 OFFSET 4");
            ...
            <div class="col-lg-6 col-md-6">
              <div class="details">
                <div class="add-to-cart">
                  <h1>EinScan Pro HD</h1>
                </div>

                <p>Structured White LED Light 3D Scanner</p>
                <h5>Accuracy: <span class="hd-scan"> HD Scan: ≤0.04 mm</span></h5>
                <small class="text-muted">₹ 7 lakhs<span class="mrp"> M.R.P. : ₹7.5 lakhs</span></small><br>
                ...
                <ul>
                  <li>
                    The scanner is equipped with advanced optics and sensors, enabling it to achieve high levels of
                    accuracy and detail in 3D scans.
                  </li>
                  <li>

                    The EinScan Pro HD supports multiple scanning modes, including handheld rapid scan, handheld HD scan,
                    fixed scan with a turntable, and fixed scan without a turntable. This versatility allows users to
                    choose the scanning mode that best fits their specific needs.
                  </li>
                </ul>
                <h5>Quantity</h5>
        ...
        <div class="product-sec owl-carousel">
          ...
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <a href="Faro-Edge-arm.php" class="btn btn-primary">Buy Now</a>
