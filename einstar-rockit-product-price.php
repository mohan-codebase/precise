...
$name  = $product ? $product['name']  : 'EINSTAR Rockit-Affordable Pocket-Size 3D Scanner';
...
if (isset($_POST['buy_now'])) {
  ...
  header("Location: direct-checkout-einstar-rockit.php?coupon=" . urlencode($coupon) . "&qty=" . urlencode($qty));
exit();
...
<head>
  ...
  <meta property="og:url" content="https://www.precise3dm.com/einstar-rockit-product-price.php" />
  <meta property="og:title" content="Einstar Rockit" />
  ...
  <meta property="og:image" content="https://www.precise3dm.com/assets/images/einstar-rockit/pro0.png" />
  <meta property="og:image:width" content="1200"/>
  <meta property="og:image:height" content="630"/>

  <meta property="twitter:card" content="summary_large_image" />
  <meta property="twitter:url" content="https://www.precise3dm.com/einstar-rockit-product-price.php" />
  <meta property="twitter:title" content="Einstar Rockit"/>
  ...
  <meta property="twitter:image" content="https://www.precise3dm.com/assets/images/einstar-rockit/pro0.png"/>

  <link rel="canonical" href="https://www.precise3dm.com/einstar-rockit-product-price.php"/>
  <!-- CSS -->
      ...
      <div class="row row-cols-lg-2 row-cols-1 ">
        <div class="col mb-4">
          <div class="row">
            ...
            <div class="col-3 col-lg-2 px-lg-0">
              <div class="sub-imgs">
                <img src="assets/images/einstar-rockit/pro0.png" alt="" onclick="changeMainImage(this)">
                <img src="assets/images/einstar-rockit/pro1.png" alt="" onclick="changeMainImage(this)">
                <img src="assets/images/einstar-rockit/pro2.png" alt="" onclick="changeMainImage(this)">
                <img src="assets/images/einstar-rockit/pro3.png" alt="" onclick="changeMainImage(this)">
                <img src="assets/images/einstar-rockit/pro4.png" alt="" onclick="changeMainImage(this)">
                <img src="assets/images/einstar-rockit/pro5.png" alt="" onclick="changeMainImage(this)">
              </div>
            </div>
            <!-- Main image -->
            <div class="col-9 col-lg-10">
              <div class="main-img">
                <img id="mainProductImage" src="assets/images/einstar-rockit/pro0.png" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col">
          <div class="product-details">
            <h1>EINSTAR Rockit-Affordable Pocket-Size 3D Scanner</h1>
            <div class="price-div">
              <h3>
            ...
            <ul class="desc">
              <li>Scan anywhere with built-in Wi-Fi and a 3-hr-swappable battery.</li>
              <li>Rocket speed capture (up to 2.8M points/s) with 90 fps tracking</li>
              <li>Switch between Laser HD and IR VCSEL modes.</li>
              <li>Built-in 5MP camera to capture real-life versatility in colors and texture</li>
              <li>Lightweight and durable design for studio and field use alike</li>
            </ul>
