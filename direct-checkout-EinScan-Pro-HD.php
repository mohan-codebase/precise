  ...
  <div class="container pt-5 pb-5">
    <div class="row">
     ...
     <form id="paymentForm" action="create_payment.php" method="post">
      ...
      $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` WHERE id = 5");
     ...
     $('body').on('click', '.buy_now', function (e) {
      ...
      if (isValid) {
        ...
        var options = {
          ...
          "name": "Einscan Pro HD",
          "description": "Payment",
          "image": "https://www.precise3dm.com/assets/images/products/product12.png",
