...
<head>
  ...
  <title>Payment Form - Einstar Vega</title>

  <meta name="description" content="Checkout - Einstar Vega | Precise3DM">
...
<body style="background-color:#FFF9F3;">
  ...
  $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` WHERE id = 16");
  $product_title = '';
  $total_quantity = 0;
  $subtotal = 0.0;
  ...
  <script>
    ...
    $('body').on('click', '.buy_now', function (e) {
      ...
      var options = {
        ...
        "name": "Einstar Vega",
        "description": "Payment",
        "image": "https://www.precise3dm.com/assets/images/Buy-Einstar-and-Einscan-3D-Scanner-Online-in-India/einstar-vega-image1.png",
