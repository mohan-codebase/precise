...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="container pt-5 pb-5">
    <div class="row">
      ...
      $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` WHERE id = 4");
    ...
    $('body').on('click', '.buy_now', function (e) {
      ...
      if (isValid) {
        ...
        var options = {
          ...
          "description": "Payment",
          "image": "https://www.precise3dm.com/assets/images/products/product13.png",
  ...
  <!-- bootstrap links-->
  <script src="https://www.paypal.com/sdk/js?client-id=ASJQyCyGK6uKYaMMyOXb1wXXW1Q4OEcSJfxV_xYzXlccJZ-efkhFTtgim2mECDU4qZRtajbrkJBtqifY&buyer- 
