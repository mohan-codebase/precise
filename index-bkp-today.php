            ...
            <div class="carousel-inner">
               <div class="carousel-item active container-fluid p-0">
                  ...
                  <div class="carousel-caption  d-md-block  text-left">
                        ...
                        <a href="3d-software-provider-in-india.php" class="btn pre-btn my-2">3D Software</a>
                  </div>
               </div>
               ...
               <div class="carousel-item">
                  ...
                  <div class="carousel-caption  d-md-block text-left">
                        ...
                        <a class="btn pre-btn my-2">Digital Benchmarking</a>
                        <a class="btn pre-btn my-2">Biw scan to cad</a>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-12 text-md-left text-center">
                  <div class="">
                     <a href="affordable-3d-scanners-in-the-market.php" class="btn pre-btn my-2 text-uppercase">Buy 3D Scanners</a>
            ...
            <div class="row">
               <div class="col-md-12 text-md-left text-center">
                  <div class="text-center">
                     <a href="https://forms.zohopublic.com/virtualoffice20215/form/GetaQuote/formperma/arTza4w3Oh5N9dIOFD8bGnEfcdb3bCEv_qdla54OBwQ" target=_blank class="btn pre-btn-alt my-2">get a rapid quotation</a>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container-fluid">
            ...
            <div class="container">
               ...
               <div class="row ">
                  <div class="col-md-12 text-md-left text-center">
                     <div class="text-center">
                        <a  href ="affordable-3d-scanners-in-the-market.php" class="btn pre-btn my-2 text-uppercase ">view all</a>
                     </div>
                  </div>
               </div>
            </div>
