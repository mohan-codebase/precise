...
<head>
   ...
   <title>Geomagic Design X Compare</title>
   ...
   <meta property="twitter:title" content="Geomagic Design X Compare"/> 
   ...
   <meta property="og:url" content="https://www.precise3dm.com/geomagic-designx-compare.php" />
   <meta property="og:image" content="https://www.precise3dm.com/assets/images/about-logo.png" />
   <meta property="og:description"
      content="Precise3DM Provides complete digital manufacturing solution that includes 3D scanning services, 3D reverse engineering, 3D Printing services & 3d Inspection for all industries" />
   <meta property="twitter:url" content="https://www.precise3dm.com/geomagic-designx-compare.php" />
   <link rel="canonical" href="https://www.precise3dm.com/geomagic-designx-compare.php"/>
   <!--bootstrap css-->
   ...
   <link rel="stylesheet" href="assets/css/geomagic.css">
   ...
   <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "@type": "ListItem", 
        "position": 2, 
        "name": "Geomagic Design X Compare",
        "item": "https://www.precise3dm.com/geomagic-designx-compare.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/geomagic-designx-compare.php"
      },
      "headline": "Geomagic Design X Compare",
...
<!-- End Google Tag Manager (noscript) -->
   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-7 col-4 theme-con">
            <label style="opacity:0;" class="custom-switch" id="customSwitchContainer">
         ...
         <div class="col-lg-5 col-8 address-con">
            ...
            <p class="dm-n">Talk to us now at <br>Sales: 9840478347 <span>|</span> +91 7395972777<br> 3D Printing:
               9025700192
            </p>
   ...
   <section style="background-size: 100% 100% !important;" class="banner">
      ...
      <div class="container geomagic-compare">
         <h1>Geomagic Design X Compare by interface</h1>
         <img src="assets/images/geomagic/compare-banner.png" alt="">
      </div>
   </section>

   <section class="compare-sec compare-main">
      <img src="assets/images/geomagic/compare1.png" alt="">
   </section>

   <section style="background-image: url(assets/images/geomagic/price-bg.png) !important;" class="compare-sec">
      <img src="assets/images/geomagic/compare2.png" alt="">
   </section>

   <section style="background-image: url(assets/images/geomagic/price-bg.png) !important;" class="compare-sec">
      <img src="assets/images/geomagic/compare3.png" alt="">
   </section>

   <section style="background-image: url(assets/images/geomagic/price-bg.png) !important;" class="compare-sec">
      <img src="assets/images/geomagic/compare4.png" alt="">
   </section>

   <section style="background-image: url(assets/images/geomagic/price-bg.png) !important;" class="compare-sec">
      <img src="assets/images/geomagic/compare5.png" alt="">
   </section>

   <section style="background-image: url(assets/images/geomagic/price-bg.png) !important;" class="compare-sec">
      <img src="assets/images/geomagic/compare6.png" alt="">
   </section>

   <section style="background-image: url(assets/images/geomagic/price-bg.png) !important;" class="compare-sec">
      <img src="assets/images/geomagic/compare7.png" alt="">
   </section>
