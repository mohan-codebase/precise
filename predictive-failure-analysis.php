...
<head>
    ...
    <meta property="og:url" content="https://www.precise3dm.com/predictive-failure-analysis.php" />
    <meta property="og:title" content="Reverse engineering freeform software-3D scan services-Scan to Predictive failure analysis" />
    ...
    <meta property="og:image" content="https://www.precise3dm.com/assets/images/predictive-failure-analysis/predictive.png" />
    <meta property="twitter:url" content="https://www.precise3dm.com/predictive-failure-analysis.php" />
    <meta property="twitter:title" content="Reverse engineering freeform software-3D scan services-Scan to Predictive failure analysis" />
    ...
    <meta property="twitter:image" content="https://www.precise3dm.com/assets/images/predictive-failure-analysis/predictive.png"/>
    <link rel="canonical" href="https://www.precise3dm.com/predictive-failure-analysis.php"/>
    <!--bootstrap css-->
    ...
    <title>Reverse engineering freeform software-3D scan services-Scan to Predictive failure analysis</title>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "item": "https://www.precise3dm.com/predictive-failure-analysis.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/predictive-failure-analysis.php"
      },
      "headline": "Reverse engineering freeform software-3D scan services-Scan to Predictive failure analysis",
      ...
      "image": "https://www.precise3dm.com/assets/images/predictive-failure-analysis/predictive.png",  
      "author": {
        "@type": "Organization",
        "name": "Precise3DM",
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section id="predictive-failure-analysis" class="pt-4">
        <div class="container">
            <div class="row h-300">
            </div>
        </div>
            ...
            <div class="container">
                <div class="row ">
                    <div class="col-md-6 aboutus-herohead pl-0">
                        <h1>Predictive failure analysis</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="" id="myTabContentnew">
                        <div class="" id="overview">
                            ...
                            <div class="overview-cont">
                                <h6>Predictive failure analysis</h6>
                                <p>Predictive Failure Analysis (PFA) refers to methods intended to predict the imminent failure of systems or components (software or hardware), and potentially enable mechanisms to avoid or counteract failure issues or recommend the maintenance of systems before failure.  The physical object that has fatigue, torsion, or bending failure information is captured by a 3D CT scanner. Datum alignment is made for reference scan data and CAD data. Limiting values for weight handling and the stress concentrations are determined in the 3D inspection software where the region is susceptible to failure regardless of the loading scenario. Using the "Location Deviation" feature the stress concentrated areas are determined and color mapping features will highlight the spots in the 3D CAD data from the undamaged reference data. The output inspection report is generated and given to the customer in desired CAD format.</p>
                            ...
                            <div class="owl-carousel owl-theme chennai-carousel-box owl-prev-set">
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                        <img src="assets/images/predictive-failure-analysis/1) Import Cad File.png"  alt="3d mesh" class="img-fluid">
                                ...
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                        <img src="assets/images/predictive-failure-analysis/2) Import 3D scan File.png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>2</span>
                                        </div>
                                ...
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                    <img src="assets/images/predictive-failure-analysis/3) Initial Allignment.png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>3</span>
                                        </div>
                                ...
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                    <img src="assets/images/predictive-failure-analysis/4) Bestfit Allignment.png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>4</span>
                                        </div>
                                        <p>Bestfit Allignment</p>
                                    </div>
                                </div>
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                    <img src="assets/images/predictive-failure-analysis/5) Checking Failure Values.png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>5</span>
                                        </div>
                                        <p>Checking Failure Values</p>
                                    </div>
                                </div>
                           
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                    <img src="assets/images/predictive-failure-analysis/6) Tabular Column.png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>6</span>
                                        </div>
                                        <p>Tabular Column</p>
                                ...
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                    <img src="assets/images/predictive-failure-analysis/7) Checking Another area.png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>7</span>
                                        </div>
                                        <p>Checking Another area</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="demo" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="assets/images/predictive-failure-analysis/predictive.png" alt="sw">
                            ...
                            <div id="demo1" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <div class="text-center py-4 bg-white">
                                            <p>Predictive failure analysis</p>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <iframe width="100%" height="345" src="https://www.youtube.com/embed/E5VhABS2rPY" allow="autoplay" id="einscan_h_vdo">
                            ...
                            <div class="overview-cont">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 whatnext-cont">
                                        ...
                                        <a href="scan-to-cad-service.php" >Upload your 3D Scan for converting into Predictive failure analysis</a>
                                    </div>
                                    <div class="col-sm-12 whatnext-cont">
