...
<head>
    ...
    <meta property="og:url" content="https://www.precise3dm.com/digital-alignment.php" />
    <meta property="og:title" content="Reverse engineering freeform software-3D scan services-Scan to Digital Alignment" />
    ...
    <meta property="twitter:url" content="https://www.precise3dm.com/digital-alignment.php" />
    <meta property="twitter:title" content="Reverse engineering freeform software-3D scan services-Scan to Digital Alignment" />
    ...
    <link rel="canonical" href="https://www.precise3dm.com/digital-alignment.php"/>
    <!--bootstrap css-->
    ...
    <title>Reverse engineering freeform software-3D scan services-Scan to Digital Alignment </title>
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "item": "https://www.precise3dm.com/digital-alignment.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/digital-alignment.php"
      },
      "headline": "Reverse engineering freeform software-3D scan services-Scan to Digital Alignment",
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section id="digital-alignment" class="pt-4">
        <div class="container">
            <div class="row h-300">
            </div>
        </div>
                    ...
                    <div class="" id="myTabContentnew">
                        <div class="" id="overview">
                            ...
                            <div class="overview-cont">
                                <h6>Digital Alignment</h6>
                                <p>3D scan data is collected independently of any datum structure, so all digital alignments are performed after the mesh is created. Any conceivable alignment is computed within the inspection software if there is enough quality scan data on the alignment surfaces. While scanning, the origin point of scan data will not be perfectly accurate. Parts will be produced in different orientations.The ability to toggle in and out of alignments provides a versatile platform to assess our production process, or simply to inspect any part. Initially, we need to extract the reference CAD geometry. A mesh is created by selecting the smart selection tools. We can also use the Lasso feature to create the mesh by best fitting options. We can create an intersection between two planes by using vector tools. The target coordinates are set to origin. Now, to align the  reference geometry we can use an interactive alignment feature with 3-2-1 alignment or XYZ position alignment to get the alignment and predefined views of the CAD model.</p>
                            ...
                            <div class="owl-carousel owl-theme chennai-carousel-box owl-prev-set">
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                        <img src="assets/images/digital-alignment/1) Import Cad File (12).png" alt="3d mesh" class="img-fluid">
                                ...
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                        <img src="assets/images/digital-alignment/2) Import 3D Scan Fille.png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>2</span>
                                        </div>
                                ...
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                        <img src="assets/images/digital-alignment/3) Initial allignment (3).png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>3</span>
                                        </div>
                                ...
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                        <img src="assets/images/digital-alignment/4) bestfit Allignment (1).png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>4</span>
                                        </div>
                                ...
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                        <img src="assets/images/digital-alignment/5) datum Allignment.png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>5</span>
                                        </div>
                                ...
                                <div class="item chennai-car-item">
                                    <div class="wf-cadcont">
                                        <img src="assets/images/digital-alignment/6) Transform Allignment.png" alt="3d mesh" class="img-fluid">
                                        <div class="text-center mt-2">
                                            <span>6</span>
                                        </div>
                                        <p>Transform Allignment</p>
                                    </div>
                                </div>
                            ...
                            <div id="demo" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="assets/images/digital-alignment/1 (3).png" alt="sw">
                                        <div class="text-center py-4 bg-white">
                                            <p>Digital Alignment</p>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/images/digital-alignment/2 (2).png" alt="sw">
                                        <div class="text-center py-4 bg-white">
                                            <p>Digital Alignment</p>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                    <img src="assets/images/digital-alignment/3 (1).png" alt="sw">
                                        <div class="text-center py-4 bg-white">
                                            <p>Digital Alignment</p>
                                        </div>
                                    </div>
                            ...
                            <div class="overview-cont">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 whatnext-cont">
                                        ...
                                        <a href="scan-to-cad-service.php" >Upload your 3D Scan for converting into Digital Alignment</a>
                                    </div>
                                    <div class="col-sm-12 whatnext-cont">
