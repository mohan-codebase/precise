...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="header pt-5">
    <h2>T-SCAN Hawk with integrated photogammetry</h2>
  </div>
  ...
  <div class="container pt-5 pb-5">
    <div class="row">
      ...
      $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` WHERE id = 6");
     ...
     $('body').on('click', '.buy_now', function (e) {
      ...
      if (isValid) {
        ...
        var options = {
          ...
          "name": "Photogrammetry",
          "description": "Payment",
          "image": "https://www.precise3dm.com/assets/images/products/product11.png",
