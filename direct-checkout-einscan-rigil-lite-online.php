...
<head>
  ...
  <title>Payment Form - EinScan Rigil Lite</title>

  <meta name="description" content="Checkout - EinScan Rigil Lite | Precise3DM">
...
<body style="background-color:#FFF9F3;">
  ...
  <div class="header pt-5">
    <h2 class="mt-lg-5">EinScan Rigil Lite</h2>
  </div>

  <?php
  // Fetch product from einscan hx table - ID 15
  $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` WHERE id = 18");
  $product_title = '';
  $total_quantity = 0;
  $subtotal = 0.0;
  ...
  <script>
    ...
    $('body').on('click', '.buy_now', function (e) {
      ...
      var options = {
        ...
        "description": "Payment",
        "image": "https://www.precise3dm.com/assets/images/Buy-Einstar-and-Einscan-3D-Scanner-Online-in-India/einScan-rigil-lite-image1.png",
