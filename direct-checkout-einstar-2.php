...
<body style="background-color:#FFF9F3;">
  ...
  <div class="header pt-5">
    <h2 class="mt-lg-5">Einstar 2</h2>
  </div>

  <?php
  // Fetch product (hard-coded id=7 as in your original)
  $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` WHERE id = 10");
  $product_title = '';
  $total_quantity = 0;
  $subtotal = 0.0; // INR
  ...
  <script>
    ...
    $('body').on('click', '.buy_now', function (e) {
      ...
      var options = {
        ...
        "name": "Einstar 2",
        "description": "Payment",
        "image": "https://www.precise3dm.com/assets/images/einstar-2/pro1.png",
