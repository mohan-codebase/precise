...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section id="events_details_banner" class="pt-4">
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-12 aboutus-herohead pl-0">
                    <h3>Technical webinar and live demo on 'Geomagic Design X and its applications'
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 eve-details-cont">
                    <button data-toggle="modal" data-target="#exampleModalCenter" type=button>REGISTER NOW</button>
                    <h5>Join us on June 18, 2021 at 06:00 PM on Geomagic Design X</h5>
                    <div class="row eve-details-2">
                        <div class="col-md-8">
                            <h4>Geomagic Design X</h4>
                            <p>With successful completion of more than 1000 projects and 50 plus Geomagic Design x software installation in the country, Precise3Dm Is very happy to host a technical webinar & "Live demo on Geomagic Design X  and Its Applications''  that contains our 3D Scanning case studies with various types of 3D Scanning Technologies in Automotive and Engineering Industry.</p>
                            <p>In 2021, Digital Reverse Engineering applications are widely used in many industries, it brings direct benefits in R&D, Product Design & Development aspects such as Modeling Lead time, Complex Geometry Creations, Freeform Surface Creation. Geomagic Design X a comprehensive Reverse engineering software it works with many 3D Scanners, Live transfers the modeling history to CAD software, and helps to convert any 3D Scanner output of mesh or point cloud into different types of CAD formats with unique properties, which can be used for many downstream applications.</p>
                        </div>
                ...
                <div class="col-md-12 eve-details-3">
                    ...
                    <h4>What you will understand</h4>
                    <ul>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                            Reverse modeling technique using Geomagic Design X
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                            3D Scanner applications with Geomagic Design X
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                            Industry-wise Reverse Engineering Applications
                        </li>
                        <li><img src="assets/images/events_images/right pointing arrow..png" alt="">
                            Precise3DM DRE service workflow
                        </li>
                    </ul>
                </div>
