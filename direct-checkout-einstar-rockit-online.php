...
<head>
  ...
  <title>Payment Form - Einstar Rock It</title>

  <meta name="description" content="Checkout - Einstar Rock It | Precise3DM">
...
<body style="background-color:#FFF9F3;">
  ...
  <div class="header pt-5">
    <h2 class="mt-lg-5">Einstar Rock It</h2>
  </div>

  <?php
  // Fetch product from einscan hx table - ID 15
  $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` WHERE id = 17");
  $product_title = '';
  $total_quantity = 0;
  $subtotal = 0.0;
  ...
  <script>
    ...
    $('body').on('click', '.buy_now', function (e) {
      ...
      var options = {
        ...
        "description": "Payment",
        "image": "https://www.precise3dm.com/assets/images/Buy-Einstar-and-Einscan-3D-Scanner-Online-in-India/einstar-rock-it-image-1.png",
