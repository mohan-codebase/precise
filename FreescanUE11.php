...
if (isset($_POST['buy_now1'])) {
  ...
  echo "<script type='text/javascript'>window.location.href='direct-checkout-Freescanue.php';</script>";
            exit();
}
?>
...
<head>
  ...
  <meta property="twitter:title" content="Freescan UE 11"/>
  <meta name="twitter:description"
    content="Precise3DM Provides complete digital manufacturing solution that includes 3D scanning services, 3D reverse engineering, 3D Printing services & 3d Inspection for all industries" />
  <meta property="og:type" content="3D Scanning" />
  <meta property="og:title" content="Freescan UE 11" />
  <meta property="og:url" content="https://www.precise3dm.com/FreescanUE11.php" />
  <meta property="twitter:url" content="https://www.precise3dm.com/FreescanUE11.php" />
  <meta property="og:image" content="https://www.precise3dm.com/assets/images/about-logo.png" />
  <meta property="og:description"
    content="Precise3DM Provides complete digital manufacturing solution that includes 3D scanning services, 3D reverse engineering, 3D Printing services & 3d Inspection for all industries" />
  <link rel="canonical" href="https://www.precise3dm.com/FreescanUE11.php"/>
  <!--bootstrap css-->
  ...
  <link rel="canonical" href="https://www.precise3dm.com/" />
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "position": 2, 
        "name": "Freescan UE 11",
        "item": "https://www.precise3dm.com/FreescanUE11.php"  
      }]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.precise3dm.com/FreescanUE11.php"
      },
      "headline": "Freescan UE 11",
...
<section class="filtersec pt-5 pb-5">
  ...
  <section class="scanner-section">
    ...
    <?php
    $select_product = mysqli_query($con, "SELECT * FROM `products` LIMIT 1 OFFSET 1 ");
      ...
      <form action="" method="post" action="">
        <div class="container">
          <div class="row">
            ...
            <?php
            $select_cart_product = mysqli_query($con, "SELECT * FROM `einscan hx` LIMIT 1 OFFSET 1");
            ...
            <div class="col-lg-6 col-md-6">
              <div class="details">
                <div class="add-to-cart">
                  <h1>Freescan UE 11</h1>
                </div>

                <p>Blue laser Handheld 3D scanner</p>
                <h5>Accuracy: <span class="hd-scan">Up to 0.02 mm</span></h5>
                <small class="text-muted">₹ 11.75 lakhs <span class="mrp"> M.R.P. : ₹12.5 lakhs </span></small><br>
                ...
                <ul>
                  ...
                  <li>
                    Metrology - Grade , High -precision inspection solutions for the Automotive, Transportation, Aerospace
                    industry, Molding inspection , Energy generation, Machinery manufacturing, etc.
                  </li>
                </ul>
                <h5>Quantity</h5>
